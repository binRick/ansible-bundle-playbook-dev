export REPO_COMMENT_CACHE_DIR=/tmp/.BORG_COMMENT_CACHE
[[ ! -d $REPO_COMMENT_CACHE_DIR ]] && mkdir -p $REPO_COMMENT_CACHE_DIR

export PYINSTALLER_ARGS=""
export PYINSTALLER_ARGS="--clean"

export DISABLE_AUTO_UPDATE=true
export USE_CACHED_SPEC_FILE=1
export USE_CACHED_SPEC_FILE=0
