...
ADDITIONAL_COMPILED_MODULES="simplejson terminaltables psutil loguru json2yaml setproctitle speedtest-cli pyyaml netaddr configparser urllib3 jmespath" # websocket-client"
...
MODULE_BIN_INCLUDES="ansible ansible-playbook json2yaml yaml2json speedtest-cli paramiko"
